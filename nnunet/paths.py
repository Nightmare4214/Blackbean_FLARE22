...
base = os.environ['nnUNet_raw_data_base'] if "nnUNet_raw_data_base" in os.environ.keys() else "/mnt/data/datasets/nnunet_dataset/nnUNet_raw_data_base"
preprocessing_output_dir = os.environ['nnUNet_preprocessed'] if "nnUNet_preprocessed" in os.environ.keys() else "/mnt/data/datasets/nnunet_dataset/nnUNet_preprocessed"
network_training_output_dir_base = os.path.join(os.environ['RESULTS_FOLDER']) if "RESULTS_FOLDER" in os.environ.keys() else "/mnt/data/datasets/nnunet_dataset/nnUNet_trained_models"
